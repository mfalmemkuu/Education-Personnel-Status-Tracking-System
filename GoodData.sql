...
-- Ministry of Education - Quebec Educational Facilities
INSERT INTO EducationalFacilities (FacilityID)
SELECT FacilityID FROM Facilities ORDER BY FacilityID DESC LIMIT 10;
