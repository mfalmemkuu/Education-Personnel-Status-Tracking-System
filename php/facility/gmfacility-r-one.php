...
$statement = $conn->prepare("SELECT gmf.FacilityID, f.Name, CONCAT(p.FirstName, ' ', p.LastName) AS PresidentName, f.WebAddress, f.Capacity, f.PostalCode, f.PhoneNumber
                             ...
                             AND gmf.FacilityID = f.FacilityID AND f.FacilityID = :FacilityID ;");
...
<body>
<h1>Displaying One General Management Office</h1> <br>
<table>
        <thead>
            <tr>
                <th>FacilityID</th>
