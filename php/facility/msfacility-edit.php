...
$statement = $conn->prepare("SELECT e.FacilityID, e.PrincipalMedicareNumber, f.Name, CONCAT(p.FirstName, ' ', p.LastName) 
                                    AS Principal_name, wa.StartDate, f.WebAddress, f.Capacity, f.PostalCode, f.PhoneNumber
                             FROM Facilities f
                             ...
                             WHERE ms.FacilityID = :FacilityID;");
...
<body>
    <h1>Edit Middle School</h1>
    <form action="./msfacility-edit.php" method="post">
